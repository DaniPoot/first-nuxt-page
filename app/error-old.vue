    ...
    <div class="error-container">
      <div class="error-content">
        ...
        <div class="error-message">
          <h2>{{ error.message || 'Página no encontrada' }}</h2>
          <p>
            {{ error.data?.myOtherField || 'Lo sentimos, la página que estás buscando no existe o ha sido movida.' }}
          </p>
        </div>
